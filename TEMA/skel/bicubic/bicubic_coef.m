function A = bicubic_coef(f, Ix, Iy, Ixy, x1, y1, x2, y2)
    ...
    M2(1, :) = [f(y1, x1) f(y2, x1) Iy(y1, x1) Iy(y2, x1)];
    M2(2, :) = [f(y1, x2) f(y2, x2) Iy(y1, x2) Iy(y2, x2)];
    M2(3, :) = [Ix(y1, x1) Ix(y2, x1) Ixy(y1, x1) Ixy(y2, x1)];
    M2(4, :) = [Ix(y1, x2) Ix(y2, x2) Ixy(y1, x2) Ixy(y2, x2)];
